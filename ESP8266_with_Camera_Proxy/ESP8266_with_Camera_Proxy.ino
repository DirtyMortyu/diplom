...
<div class="info">
  ...
  <p><strong>Статус:</strong> <span class=")rawliteral" +
    (client.connected() ? "ok\">✅ Connected" : "err\">❌ Disconnected") + R"rawliteral(</span></p>
</div>
<div class="info">
  <h3>💾 Memory</h3>
...
void setup() {
  ...
  // HTTP статус страница
  server.on("/", handleRoot);
  server.begin();

  Serial.println("\n========================================");
  Serial.println("✅ ESP8266 готов!");
  Serial.println("========================================\n");
}
